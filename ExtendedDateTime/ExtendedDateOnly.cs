...
/// <summary>
/// Class <c>ExtendedDate</c> Models A DateOnly Object that has extended reach to Int.MinValue and Int.MaxValue. 
...
public class ExtendedDateOnly : IComparable<ExtendedDateOnly>, IEquatable<ExtendedDateOnly>
{
    ...
    {
        if (identifier is TimeUnits.Day or TimeUnits.Month or TimeUnits.Year)
        {
